...
NEXT_PUBLIC_VLM_MIN_KEYFRAMES=8
NEXT_PUBLIC_VLM_MAX_KEYFRAMES=16
...
# ROBOT_DATA_STUDIO_OLLAMA_BASE_URL=http://127.0.0.1:11434
# Or run an in-process Transformers vision-language pipeline:
# ROBOT_DATA_STUDIO_VLM_PROVIDER=transformers
# ROBOT_DATA_STUDIO_TRANSFORMERS_VLM_MODEL=HuggingFaceTB/SmolVLM-Instruct
# ROBOT_DATA_STUDIO_TRANSFORMERS_VLM_TASK=image-text-to-text
